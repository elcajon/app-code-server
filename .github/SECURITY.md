...
please report it via [GitHub Security Advisories](https://github.com/elcajon/app-code-server/security/advisories).
...
Please create a [new Security Advisory](https://github.com/elcajon/app-code-server/security/advisories/new)
